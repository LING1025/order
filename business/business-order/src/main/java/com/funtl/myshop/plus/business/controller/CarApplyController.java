...
//        distance.setDuration(jsonObject.getDouble("duration"));
    ...
    @ApiOperation(value = "用车申请：获取用车类别、牌照地区、车辆选择、事由说明类别")
    @ApiImplicitParam(name = "itemType", value = "用车类别：833,牌照地区：810,车辆选择类别：231,事由说明：865",required = true,dataType ="int",paramType = "path")
